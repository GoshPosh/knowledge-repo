...
# This is for a Local Deploymnet without external access.
...
AUTH_USER_ATTRIBUTE_CACHE_LIFETIME = 1 * 60 * 60  # 1 hour
...
REMEMBER_COOKIE_DURATION = datetime.timedelta(days=0)
