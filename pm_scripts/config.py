...
# ---------------------------------------------------
SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root@localhost/kr'
...
### -- GitHub
"""
OAUTH_OAUTH2_BASE_URL = 'https://api.github.com/'
OAUTH_OAUTH2_AUTHORIZATION_URL = 'https://github.com/login/oauth/authorize'
OAUTH_OAUTH2_TOKEN_URL = 'https://github.com/login/oauth/access_token',
OAUTH_OAUTH2_AUTO_REFRESH_URL = None
OAUTH_OAUTH2_SCOPES = None
OAUTH_OAUTH2_USER_INFO_ENDPOINT = 'user'
OAUTH_OAUTH2_USER_INFO_MAPPING = {
     'identifier': 'email',
     'name': 'name',
...
# Okta
#OAUTH_OAUTH2_BASE_URL = 'https://dev-476499.okta.com'
#OAUTH_OAUTH2_AUTHORIZATION_URL = 'https://dev-476499.okta.com/oauth2/default/v1/authorize'
#OAUTH_OAUTH2_TOKEN_URL = 'https://dev-476499.okta.com/oauth2/default/v1/token',
#OAUTH_OAUTH2_AUTO_REFRESH_URL = 'https://dev-476499.okta.com/oauth2/default/v1/token'
#OAUTH_OAUTH2_SCOPES = ["openid", "email", "profile", "offline_access"]
#OAUTH_OAUTH2_USER_INFO_ENDPOINT = 'userinfo'
"""
OAUTH_OAUTH2_USER_INFO_MAPPING = {
     'identifier': 'email',
     'name': 'name'
...
INDEXING_INTERVAL = 1 * 60  # 1 minutes
...
WEB_EDITOR_PREFIXES = ['growth','product','markets','operations','platform','stash','onboarding']
